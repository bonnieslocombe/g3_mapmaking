...
Telescope and detector data for CCAT will be available in .g3 file format and packaged into a bound book for mapmaking. Since real data is not yet available, simulated data was used. 

HDF5 files from a TOAST simulation of Jupiter were converted to .g3 files and used to explore the file format and become familiar with pipeline operations. This simulation utilized 100 randomly selected detectors on the CCAT array and excluded noise.
